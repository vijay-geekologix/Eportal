...
/>
            ...
            <div className="mb-6 flex flex-wrap items-center gap-4">
              ...
              <button className="bg-orange-400 hover:bg-orange-500 text-white px-4 py-2 rounded-md transition-colors">
                Refresh
              </button>
              <div className="flex items-center gap-2">
                <input
            ...
            <div className="overflow-x-auto max-w-full">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    {["Date", "Day", "Shift Code", "First Login", "Last Logout", "User Type1", "User Type2", "Portion", "Tot. Hrs.", "LateMark_Calc", "WO/PH Extra Hours", "Eff. Extra Working Hrs"].map((header) => (
